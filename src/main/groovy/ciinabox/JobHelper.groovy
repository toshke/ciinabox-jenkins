...
import ciinabox.ext.ExtensionBase
import ciinabox.ext.ICiinaboxExtension
import com.base2.util.ReflectionUtils
import javaposse.jobdsl.dsl.Job

class JobHelper {

  static void defaults(Job job, def vars) {
    ...
    ReflectionUtils.getTypesImplementingInterface(ExtensionBase, 'ciinabox.ext')
            .each {Class<? extends ExtensionBase, ICiinaboxExtension> clazz ->
      def extension = clazz.newInstance()

      extension.setJobConfiguration(vars)
      extension.extend(job)
    }
